...
/**
 * Credential used to authorize with the {@link ClaimsBasedSecurityNode}.
 */
class CbsTokenCredential implements TokenCredential {
    private static final String SHARED_ACCESS_SIGNATURE_FORMAT = "SharedAccessSignature sr=%s&sig=%s&se=%s&skn=%s";
    private static final String HASH_ALGORITHM = "HMACSHA256";

    private final ClientLogger logger = new ClientLogger(CbsTokenCredential.class);
     ...
     *     the shared access signatures.
     */
    public CbsTokenCredential(String policyName, String sharedAccessKey, Duration tokenValidity) {
     ...
     */
    public CbsTokenCredential(String sharedAccessSignature) {
    ...
    /**
     * Retrieves the token, given the audience/resources requested to authorize against.
     *
